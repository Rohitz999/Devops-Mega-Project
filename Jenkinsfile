pipeline{
    ...
    stages{
        ...
        stage("Checkout from SCM"){
            steps {
                git branch: 'main', credentialsId: 'github-cred', url: 'https://github.com/Rohitz999/Devops-Mega-Project.git'
            }
    ...
    post {
          success {
              emailext (
                  to: 'rohitvishwakarma8082@gmail.com',
